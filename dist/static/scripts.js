...
function updateGrid(){
	...
	for(var i =0; i < gridElements.length; i++){
		$("#grid").append('<div class="card animated bounce '+gridElements[i]._id+' usercard" style="width: 20rem;"><img class="card-img-top" src="'+String(gridElements[i]['imgurl'])+'" alt="Card image cap"><div class="card-body"><small class="card-text">'+String(gridElements[i]['description'])+'</small></div></div>');
